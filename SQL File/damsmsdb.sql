...
INSERT INTO `tblappointment` (`ID`, `AppointmentNumber`, `Name`, `MobileNumber`, `Email`, `AppointmentDate`, `AppointmentTime`, `location`, `Doctor`, `Message`, `ApplyDate`, `Remark`, `Status`, `UpdationDate`) VALUES
...
INSERT INTO `tbldoctor` (`ID`, `FullName`, `MobileNumber`, `Email`, `location`, `Password`, `CreationDate`) VALUES
...
(1, 'aboutus', 'About Us', 'A Veterinarian is a professional who treates the injuries and illness of animals. We use medical tools and X-rays machine for the same. In some situations we perform emergency surgeries. It is our goal for your pets to live long and healthy lives, and we offer friendly and personalized attention to make sure this happens. No matter what type of treatment your animal is receiving, you can trust that they will be comfortable in our state-of-the-art, inviting facility. ', NULL, NULL, NULL, ''),
...
INSERT INTO `tblspecialization` (`ID`, `location`, `CreationDate`) VALUES
(1, 'Angelore', '2022-11-09 14:22:33'),
(2, 'Bendur', '2022-11-09 14:23:42'),
(3, 'Cordel', '2022-11-09 14:24:14'),
(4, 'Derebail', '2022-11-09 14:24:42'),
(5, 'Hampankatta', '2022-11-09 14:25:06'),
(6, 'Jyothi', '2022-11-09 14:25:31'),
(7, 'Milagres', '2022-11-09 14:25:52'),
(8, 'Nanthoor', '2022-11-09 14:27:18'),
(9, 'Pvs circle', '2022-11-09 14:27:52'),
(10, 'Surathkal', '2022-11-09 14:28:32'),
(11, 'Thokottu', '2022-11-09 14:29:12'),
(12, 'Urwa', '2022-11-09 14:29:51'),
(13, 'Vamanjoor', '2022-11-09 14:30:13');
