...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">VAMS</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign Up With Your VAMS Account</h4>
...
{               ?>
				<option value="<?php  echo htmlentities($row1->ID);?>"><?php  echo htmlentities($row1->location);?></option><?php $cnt=$cnt+1;}} ?> 
			</select>
